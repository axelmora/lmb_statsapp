...
scip2019_new <- read_csv("/Users/axel.mora/Documents/lmb_statsapp/spraychart/scip2019_new.csv")
chadwick <- read_csv("/Users/axel.mora/Documents/lmb_statsapp/spraychart/chadwick.csv")
