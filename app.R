...
ui <- bs4DashPage(
  ...
  sidebar = bs4DashSidebar(
    ...
    bs4SidebarMenu(
      ...
      bs4SidebarMenuItem(
        ...
        bs4SidebarMenuSubItem(
          "Rosters",
          tabName = "team_rosters",
          icon = icon("address-book")
        ),
        bs4SidebarMenuSubItem(
          "Transactions",
          tabName = "team_transactions",
  ...
  body = bs4DashBody(
    bs4TabItems(
      bs4TabItem(
        tabName = "player_hit",
        ui_player_stats("ui_player_stats_1")
      ),
      bs4TabItem(
        tabName = "team_stats",
        ui_team_stats("ui_team_stats_1")
      ),
      bs4TabItem(
        tabName = "team_rosters",
        ui_rosters("ui_rosters_1")
      ),
      bs4TabItem(
        tabName = "team_transactions",
        ui_transactions("ui_transactions_1")
      ),
      bs4TabItem(
        tabName = "player_comparison",
        playerComparisonUI("comparison")
      ),
      bs4TabItem(
        tabName = "game_logs",
        h3("Game Logs"),
        ui_game_logs("ui_game_logs_1")
      ),
  ...
  controlbar = bs4DashControlbar(
    ...
    skin = "light",
    title = "Filters",
    collapsed = FALSE,  # open by default (set TRUE to start closed)
